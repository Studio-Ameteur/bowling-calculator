...
class OverlayWindow(tk.Toplevel):
    ...
    def _draw_table(self):
        ...
        for idx, s in enumerate(shown):
            ...
            max_cell = tk.Frame(row, bg=row_bg)
            max_cell.pack(side="left", padx=(4, 2))

            if diff_text:
                tk.Label(max_cell, text=diff_text, bg=row_bg,
